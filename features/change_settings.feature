Feature: Testig the ability to change settings
  ...
  Scenario: Changing the settings with correct details
    ...
    When I fill in "consumer_key" with "SOMETHING" within "form"
    When I fill in "consumer_secret" with "SOMETHING" within "form"
    When I fill in "access_token" with "SOMETHING" within "form"
    When I fill in "access_token_secret" with "SOMETHING" within "form"
